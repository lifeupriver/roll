  ...
  reel_clips: [
    {
      ...
      photos: {
        id: uuid(107),
        thumbnail_url: pickPhoto(7),
        media_type: 'video',
        duration_ms: 20000,
        storage_key: SAMPLE_VIDEOS[0],
        preview_storage_key: SAMPLE_VIDEOS[0],
      },
    },
    {
      id: uuid(501),
      ...
      photos: {
        id: uuid(117),
        thumbnail_url: pickPhoto(17),
        media_type: 'video',
        duration_ms: 20000,
        storage_key: SAMPLE_VIDEOS[1],
        preview_storage_key: SAMPLE_VIDEOS[1],
      },
    },
    {
      id: uuid(502),
      ...
      photos: {
        id: uuid(127),
        thumbnail_url: pickPhoto(27),
        media_type: 'video',
        duration_ms: 20000,
        storage_key: SAMPLE_VIDEOS[2],
        preview_storage_key: SAMPLE_VIDEOS[2],
      },
    },
    {
      id: uuid(503),
      ...
      photos: {
        id: uuid(137),
        thumbnail_url: pickPhoto(37),
        media_type: 'video',
        duration_ms: 20000,
        storage_key: SAMPLE_VIDEOS[3],
        preview_storage_key: SAMPLE_VIDEOS[3],
      },
    },
  ],
