...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    title: gallery ? `${gallery.title} — ${gallery.business_name || 'Roll Gallery'}` : 'Gallery Not Found',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#fafafa]">
        <div className="text-center">
          ...
          <p className="text-[#666]">This gallery may have been removed or the link is incorrect.</p>
        </div>
      </div>
    );
  }
