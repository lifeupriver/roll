...
export default function CirclePage() {
  ...
  return (
    <div className="flex flex-col gap-[var(--space-section)] pb-8">
      ...
      {selectedPost &&
        (() => {
          const photos = (selectedPost.photos ?? []).sort(
          ...
          const authorName =
            selectedPost.profiles?.display_name || selectedPost.profiles?.email || 'Unknown';
                  ...
                  {REACTIONS.map(({ type, emoji }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {count > 0 && (
                          <span
                            className={`font-[family-name:var(--font-mono)] ${isActive ? 'text-[var(--color-action)]' : 'text-[var(--color-ink-secondary)]'}`}
                          >
                            {count}
                          </span>
                        )}
                        ...
                        <div className="w-7 h-7 rounded-full flex-shrink-0 overflow-hidden mt-0.5 ring-1 ring-[var(--color-action)]/20">
                          {c.profiles?.avatar_url ? (
                            ...
                            <div className="w-full h-full bg-[var(--color-action-subtle)] flex items-center justify-center">
                              <span className="text-[9px] font-medium text-[var(--color-action)]">
                                {cInitial}
                              </span>
                            </div>
                          )}
                ...
                <div className="flex items-center gap-[var(--space-component)]">
                  ...
                  <div>
                    ...
                    <p className="text-[length:var(--text-caption)] text-[var(--color-ink-secondary)]">
                      {activeSettingsCircle.member_count} member
                      {activeSettingsCircle.member_count !== 1 ? 's' : ''}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-[var(--space-element)]">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-[var(--space-element)]">
                      {settings.privacy === 'private' ? (
                        <Lock size={16} className="text-[var(--color-ink-secondary)]" />
                      ) : (
                    ...
                    <button
                      ...
                      onClick={() =>
                        setSettings((s) => ({
                          ...s,
                          privacy: s.privacy === 'private' ? 'public' : 'private',
                        }))
                      }
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${settings.privacy === 'private' ? 'translate-x-[22px]' : 'translate-x-0.5'}`}
                      />
                    </button>
                  </div>
                  <p className="text-[length:var(--text-caption)] text-[var(--color-ink-tertiary)]">
                    {settings.privacy === 'private'
                      ...
                      : 'Anyone with the link can view posts'}
                  </p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setSettings((s) => ({ ...s, approveNewMembers: !s.approveNewMembers }))
                      }
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${settings.approveNewMembers ? 'translate-x-[22px]' : 'translate-x-0.5'}`}
                      />
                    </button>
                  </div>
                </div>
              ...
              <div className="p-[var(--space-component)] border-b border-[var(--color-border)]">
                ...
                <div className="flex flex-col gap-[var(--space-element)]">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-[var(--space-element)]">
                      {settings.muteCircle ? (
                        <EyeOff size={16} className="text-[var(--color-ink-secondary)]" />
                      ) : (
                        <Eye size={16} className="text-[var(--color-ink-secondary)]" />
                      )}
                      <span className="text-[length:var(--text-body)] text-[var(--color-ink)]">
                        Mute this circle
                      </span>
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${settings.muteCircle ? 'translate-x-[22px]' : 'translate-x-0.5'}`}
                      />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <div
                        className={`absolute top-0.5 w-5 h-5 rounded-full bg-white shadow transition-transform ${settings.showActivity ? 'translate-x-[22px]' : 'translate-x-0.5'}`}
                      />
                    </button>
                  </div>
                </div>
