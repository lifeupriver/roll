...
import { Smartphone, Film, ChevronRight, MousePointerClick, X, Calendar, Wand2 } from 'lucide-react';
        ...
        {clusters.length > 0 && (
          <div className="mb-[var(--space-component)]">
            ...
            >
              ...
              <ChevronRight
                size={14}
                className={`transition-transform ${showMoments ? 'rotate-90' : ''}`}
              />
            </button>
            {showMoments && (
              <div className="flex flex-col gap-[var(--space-tight)]">
                {clusters.slice(0, 5).map((cluster) => (
                  <MomentClusterCard
                    ...
                    coverPhoto={
                      {
                        id: cluster.cover_photo.id,
                        thumbnail_url: cluster.cover_photo.thumbnail_url,
                      } as import('@/types/photo').Photo
                    }
                ...
                <div className="flex items-center gap-[var(--space-element)]">
                  ...
                  <div>
                    <span className="text-[length:var(--text-label)] text-[var(--color-ink-secondary)]">
                      Pick {maxPhotos - rollCount} more favorites to complete your roll of{' '}
                      {maxPhotos}.
                    </span>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-[var(--space-element)]">
                ...
                <div>
                  ...
                  <p className="text-[length:var(--text-caption)] text-[var(--color-ink-tertiary)]">
                    A roll is 36 of your favorite photos — like a roll of film. Pick your best,
                    choose a film stock, and we&apos;ll develop them into prints.
                  </p>
                </div>
              </div>
              <button
